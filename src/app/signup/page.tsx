  ...
  if (checkYourEmail) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center px-5">
        <div className="w-full max-w-sm rounded-2xl border border-border bg-surface p-6 shadow-[0_0_0_1px_rgba(var(--accent-rgb)/0.08)] sm:p-8 text-center">
    ...
    <div className="flex min-h-screen flex-col items-center justify-center px-5">
      <div className="w-full max-w-sm rounded-2xl border border-border bg-surface p-6 shadow-[0_0_0_1px_rgba(var(--accent-rgb)/0.08)] sm:p-8">
        ...
        <p className="mt-1 text-sm text-muted">
          Enter your details or sign up with a provider.
        </p>

        <div className="mt-6 flex flex-col gap-3">
          <form action="/api/auth/sign-in/social" method="POST" className="contents">
            <input type="hidden" name="provider" value="google" />
            <input type="hidden" name="callbackURL" value={callbackURL} />
            <button
              type="submit"
              className="hero-cta-btn relative flex w-full items-center justify-center gap-2 overflow-hidden rounded-lg bg-black px-4 py-3 text-sm font-medium text-white transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-white/50 focus:ring-offset-2 focus:ring-offset-transparent sm:text-base"
            >
