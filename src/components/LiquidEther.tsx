...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class CommonClass {
      ...
      clock: { getDelta: () => number; start: () => void } | null = null;
...
`;
    ...
    class Advection extends ShaderPass {
      ...
      update(
        ...args: { dt?: number; isBounce?: boolean; BFECC?: boolean }[]
      ) {
    ...
    class ExternalForce extends ShaderPass {
      ...
      update(
        ...
        const cellScale = (props.cellScale || { x: 1, y: 1 }) as THREE.Vector2;
    ...
    class Viscous extends ShaderPass {
      ...
      update(
        ...
        for (let i = 0; i < iter; i++) {
          ...
          const fbo_out_ =
            i % 2 === 0 ? this.props.output1 : this.props.output0;
          this.uniforms.velocity_new.value = (fbo_in as THREE.WebGLRenderTarget).texture;
          this.props.output = fbo_out_;
          if (typeof dt === "number") this.uniforms.dt.value = dt;
          super.update();
          fbo_out = fbo_out_ as THREE.WebGLRenderTarget;
        }
        return fbo_out;
      }
    }
    ...
    class Pressure extends ShaderPass {
      ...
      update(
        ...args: { vel?: THREE.WebGLRenderTarget; pressure?: THREE.WebGLRenderTarget }[]
      ) {
    ...
    class WebGLManager implements LiquidEtherWebGL {
      props: { $wrapper: HTMLElement } & Record<string, unknown>;
      output!: Output;
      ...
      constructor(props: { $wrapper: HTMLElement } & Record<string, unknown>) {
        this.props = props;
  ...
  useEffect(() => {
    ...
    if (webgl.autoDriver) {
      ...
      if (webgl.autoDriver.mouse) {
        (webgl.autoDriver.mouse as { autoIntensity: number }).autoIntensity =
          autoIntensity;
        (webgl.autoDriver.mouse as { takeoverDuration: number }).takeoverDuration =
          takeoverDuration;
      }
    }
    if (resolution !== prevRes) sim.resize();
