...
const MenuItem: React.FC<MenuItemProps> = ({
  ...
  return (
    ...
    >
      <a
        className="relative flex h-full cursor-pointer items-center justify-center font-semibold uppercase no-underline"
        href={link}
        onMouseEnter={handleMouseEnter}
        onMouseLeave={handleMouseLeave}
        style={{ color: textColor, fontSize: "4vh" }}
      >
        {text}
      </a>
      <div
      ...
      >
        <div className="flex h-full w-fit" ref={marqueeInnerRef}>
          {[...Array(repetitions)].map((_, idx) => (
            ...
            >
              <span
                className="whitespace-nowrap px-[1vw] font-normal uppercase"
